...
;
	($.$hyoo_talks_person_settings) = class $hyoo_talks_person_settings extends ($.$mol_page) {
		name(next){
			if(next !== undefined) return next;
			return "";
		}
		...
		Background(){
			const obj = new this.$.$mol_string();
			(obj.value) = (next) => ((this.background(next)));
			return obj;
		}
		Background_field(){
			const obj = new this.$.$mol_form_field();
		...
		Form(){
			...
			(obj.form_fields) = () => ([(this.Name_field()), (this.Background_field())]);
			return obj;
		}
		person(){
	...
	($mol_mem(($.$hyoo_talks_person_settings.prototype), "name"));
	($mol_mem(($.$hyoo_talks_person_settings.prototype), "Name"));
	($mol_mem(($.$hyoo_talks_person_settings.prototype), "Name_field"));
	($mol_mem(($.$hyoo_talks_person_settings.prototype), "background"));
	($mol_mem(($.$hyoo_talks_person_settings.prototype), "Background"));
	($mol_mem(($.$hyoo_talks_person_settings.prototype), "Background_field"));
	($mol_mem(($.$hyoo_talks_person_settings.prototype), "Form"));
	($mol_mem(($.$hyoo_talks_person_settings.prototype), "person"));
...
;
	($.$mol_icon_arrow_up_bold) = class $mol_icon_arrow_up_bold extends ($.$mol_icon) {
		path(){
...
;
	($.$hyoo_talks_person_avatar) = class $hyoo_talks_person_avatar extends ($.$mol_link) {
		id(){
			return "";
		}
		Image(){
	...
	($mol_mem(($.$hyoo_talks_person_avatar.prototype), "Image"));
	($mol_mem(($.$hyoo_talks_person_avatar.prototype), "Online"));
	($mol_mem(($.$hyoo_talks_person_avatar.prototype), "Name"));
	($mol_mem(($.$hyoo_talks_person_avatar.prototype), "person"));
...
;
	($.$hyoo_talks_message_bubble) = class $hyoo_talks_message_bubble extends ($.$mol_list) {
		side(){
			return "other";
		}
		editable_faorce(next){
			if(next !== undefined) return next;
			return null;
		}
		author(){
		...
		attr(){
			return {...(super.attr()), "hyoo_talks_message_bubble_side": (this.side())};
		}
		event(){
			return {"dblclick": (next) => (this.editable_faorce(next))};
		}
		rows(){
			return [
				(this.Meta()), 
		...
		Peek(){
			...
			(obj.checked) = (next) => ((this.peek(next)));
			return obj;
		}
		Preview(id){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ((this.preview_uri(id)));
			(obj.sub) = () => ([(this.Preview_embed(id))]);
			return obj;
		}
	};
	($mol_mem(($.$hyoo_talks_message_bubble.prototype), "editable_faorce"));
	($mol_mem(($.$hyoo_talks_message_bubble.prototype), "author"));
	($mol_mem(($.$hyoo_talks_message_bubble.prototype), "Author"));
	($mol_mem(($.$hyoo_talks_message_bubble.prototype), "When"));
	($mol_mem(($.$hyoo_talks_message_bubble.prototype), "Meta"));
	($mol_mem(($.$hyoo_talks_message_bubble.prototype), "text"));
	($mol_mem(($.$hyoo_talks_message_bubble.prototype), "Text"));
	($mol_mem(($.$hyoo_talks_message_bubble.prototype), "Previews"));
	($mol_mem(($.$hyoo_talks_message_bubble.prototype), "peek"));
	($mol_mem_key(($.$hyoo_talks_message_bubble.prototype), "Preview_embed"));
	($mol_mem(($.$hyoo_talks_message_bubble.prototype), "message"));
	($mol_mem(($.$hyoo_talks_message_bubble.prototype), "Peek"));
	($mol_mem_key(($.$hyoo_talks_message_bubble.prototype), "Preview"));
...
;
	($.$hyoo_talks_chat_page) = class $hyoo_talks_chat_page extends ($.$mol_page) {
		title(next){
			if(next !== undefined) return next;
			return "";
		}
		...
		Joined(){
			...
			(obj.checked) = (next) => ((this.joined(next)));
			return obj;
		}
		Search_toggle_icon(){
		...
		Draft_send(){
			...
			(obj.sub) = () => ([(this.Draft_send_icon())]);
			(obj.click) = (next) => ((this.draft_send(next)));
			return obj;
		}
		draft_controls(){
			return [
		...
		Send_key(){
			const obj = new this.$.$mol_hotkey();
			(obj.mod_ctrl) = () => (true);
			(obj.key) = () => ({"enter": (next) => (this.draft_send(next)), "F": (next) => (this.search_start(next))});
			return obj;
		}
		messages(next){
			if(next !== undefined) return next;
		...
		attr(){
			return {...(super.attr()), "hyoo_talks_chat_page_embed": (this.embed())};
		}
		Title(){
			const obj = new this.$.$mol_string();
	...
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "title"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "dump_blob"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "Dump"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "Joined_icon"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "joined"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "Joined"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "Search_toggle_icon"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "search_enabled"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "Search_toggle"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "search"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "search_end"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "Search"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "Bubbles"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "draft_text"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "Draft_text"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "Speech_toggle_icon"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "hearing"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "Speech_toggle"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "Draft_send_icon"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "draft_send"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "Draft_send"));
	($mol_mem_key(($.$hyoo_talks_chat_page.prototype), "message"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "search_start"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "Send_key"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "messages"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "chat"));
	($mol_mem(($.$hyoo_talks_chat_page.prototype), "Title"));
	($mol_mem_key(($.$hyoo_talks_chat_page.prototype), "Bubble"));
...
;
	($.$hyoo_talks) = class $hyoo_talks extends ($.$mol_book2) {
		background(){
			return "";
		}
		Theme(){
		...
		Links_query(){
			const obj = new this.$.$mol_search();
			(obj.query) = (next) => ((this.links_query(next)));
			return obj;
		}
		links(){
			return [];
		...
		roster_body(){
			return [(this.Links_query()), (this.Links())];
		}
		yard(){
			const obj = new this.$.$hyoo_sync_yard();
			return obj;
		...
		attr(){
			return {...(super.attr()), "hyoo_talks_embed": (this.embed())};
		}
		style(){
			return {...(super.style()), "background-image": (this.background())};
		}
		plugins(){
			return [(this.Theme())];
		}
	...
	($mol_mem(($.$hyoo_talks.prototype), "Theme"));
	($mol_mem(($.$hyoo_talks.prototype), "chat_new"));
	($mol_mem(($.$hyoo_talks.prototype), "Chat_new_icon"));
	($mol_mem(($.$hyoo_talks.prototype), "Chat_new"));
	($mol_mem(($.$hyoo_talks.prototype), "links_query"));
	($mol_mem(($.$hyoo_talks.prototype), "Links_query"));
	($mol_mem(($.$hyoo_talks.prototype), "Links"));
	($mol_mem(($.$hyoo_talks.prototype), "yard"));
	($mol_mem(($.$hyoo_talks.prototype), "Online"));
	($mol_mem(($.$hyoo_talks.prototype), "Source"));
	($mol_mem(($.$hyoo_talks.prototype), "Lights"));
	($mol_mem(($.$hyoo_talks.prototype), "Settings_icon"));
	($mol_mem(($.$hyoo_talks.prototype), "Settings_link"));
	($mol_mem(($.$hyoo_talks.prototype), "User"));
	($mol_mem(($.$hyoo_talks.prototype), "Settings_close_icon"));
	($mol_mem(($.$hyoo_talks.prototype), "Settings_close"));
	($mol_mem_key(($.$hyoo_talks.prototype), "chat"));
	($mol_mem(($.$hyoo_talks.prototype), "Chat_icon"));
	($mol_mem(($.$hyoo_talks.prototype), "Chat_close"));
	($mol_mem(($.$hyoo_talks.prototype), "Roster"));
	($mol_mem(($.$hyoo_talks.prototype), "Settings"));
	($mol_mem_key(($.$hyoo_talks.prototype), "Chat_page"));
	($mol_mem_key(($.$hyoo_talks.prototype), "Chat_unread_count"));
	($mol_mem_key(($.$hyoo_talks.prototype), "Chat_link_title"));
	($mol_mem_key(($.$hyoo_talks.prototype), "Chat_link"));
...
var $;
(function ($) {
    class $bog_talks_message extends $giper_baza_entity.with({
        Text: $giper_baza_atom_text,
    }) {
        get id() { return this.link().str; }
        state() {
    ...
    $.$bog_talks_message = $bog_talks_message;
})($ || ($ = {}));
...
var $;
(function ($) {
    class $bog_talks_chat extends $giper_baza_entity.with({
        Messages: $giper_baza_list_link.to(() => $bog_talks_message),
    }) {
        get id() { return this.land_link().str; }
        state() {
            throw new Error('Use Giper Baza API');
        }
        domain() {
        ...
        message_new() {
            return this.Messages(null).make(null);
        }
        /**
    ...
    __decorate([
        $mol_action
    ], $bog_talks_chat.prototype, "message_new", null);
    $.$bog_talks_chat = $bog_talks_chat;
})($ || ($ = {}));
...
var $;
(function ($) {
    class $bog_talks_person extends $giper_baza_entity.with({
        Name: $giper_baza_atom_text,
    ...
    $.$bog_talks_person = $bog_talks_person;
})($ || ($ = {}));

;
	($.$bog_talks_person_settings) = class $bog_talks_person_settings extends ($.$hyoo_talks_person_settings) {
		pass_key(){
			return "";
		}
		Pass_key(){
			const obj = new this.$.$mol_string();
			(obj.value) = () => ((this.pass_key()));
			(obj.enabled) = () => (false);
			return obj;
		}
		Pass_field(){
			const obj = new this.$.$mol_form_field();
			(obj.name) = () => ((this.$.$mol_locale.text("$bog_talks_person_settings_Pass_field_name")));
			(obj.control) = () => ((this.Pass_key()));
			return obj;
		}
		person(){
			const obj = new this.$.$bog_talks_person();
			return obj;
		}
		body(){
			return [(this.Form()), (this.Pass_field())];
		}
	};
	($mol_mem(($.$bog_talks_person_settings.prototype), "Pass_key"));
	($mol_mem(($.$bog_talks_person_settings.prototype), "Pass_field"));
	($mol_mem(($.$bog_talks_person_settings.prototype), "person"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_talks_person_settings extends $.$bog_talks_person_settings {
            pass_key() {
                return this.$.$giper_baza_auth.current().pass().toString();
            }
        }
        $$.$bog_talks_person_settings = $bog_talks_person_settings;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_talks_person_avatar) = class $bog_talks_person_avatar extends ($.$hyoo_talks_person_avatar) {
		person(){
			const obj = new this.$.$bog_talks_person();
			return obj;
		}
	};
	($mol_mem(($.$bog_talks_person_avatar.prototype), "person"));
...
;
	($.$bog_talks_message_bubble) = class $bog_talks_message_bubble extends ($.$hyoo_talks_message_bubble) {
		message(){
			const obj = new this.$.$bog_talks_message();
			return obj;
		}
		author(){
			const obj = new this.$.$bog_talks_person();
		...
		Author(){
			const obj = new this.$.$bog_talks_person_avatar();
			(obj.person) = () => ((this.author()));
			return obj;
		}
	};
	($mol_mem(($.$bog_talks_message_bubble.prototype), "message"));
	($mol_mem(($.$bog_talks_message_bubble.prototype), "author"));
	($mol_mem(($.$bog_talks_message_bubble.prototype), "Author"));
...
var $;
(function ($) {
    class $bog_talks_domain extends $mol_object {
        static yard() {
        ...
        static Message(link) {
            if (link.head().str) {
                return this.$.$giper_baza_glob.Pawn(link, $bog_talks_message);
            }
    ...
    __decorate([
        $mol_action
    ], $bog_talks_domain, "chat_new", null);
    $.$bog_talks_domain = $bog_talks_domain;
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_talks_message_bubble extends $.$bog_talks_message_bubble {
            domain() {
        ...
        __decorate([
            $mol_mem
        ], $bog_talks_message_bubble.prototype, "side", null);
        __decorate([
            $mol_mem
        ], $bog_talks_message_bubble.prototype, "editable", null);
        $$.$bog_talks_message_bubble = $bog_talks_message_bubble;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_talks_chat_page) = class $bog_talks_chat_page extends ($.$hyoo_talks_chat_page) {
		Rights_icon(){
		...
		Rights_link(){
			...
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_talks_chat_page_Rights_link_hint")));
			(obj.trigger_content) = () => ([(this.Rights_icon())]);
			(obj.bubble_content) = () => ((this.rights_panel()));
			return obj;
		}
		dump_name(){
			return "chat.сsv";
		...
		Dump(){
			const obj = new this.$.$mol_button_download();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_talks_chat_page_Dump_hint")));
			(obj.file_name) = () => ((this.dump_name()));
			(obj.blob) = () => ((this.dump_blob()));
			return obj;
		}
		...
		Joined(){
			const obj = new this.$.$mol_check_icon();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_talks_chat_page_Joined_hint")));
			(obj.Icon) = () => ((this.Joined_icon()));
			(obj.checked) = (next) => ((this.joined(next)));
			return obj;
		}
		...
		Search_toggle(){
			const obj = new this.$.$mol_check_icon();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_talks_chat_page_Search_toggle_hint")));
			(obj.Icon) = () => ((this.Search_toggle_icon()));
			(obj.checked) = (next) => ((this.search_enabled(next)));
			return obj;
		}
		...
		chat(){
			const obj = new this.$.$bog_talks_chat();
			return obj;
		}
		messages(next){
			if(next !== undefined) return next;
		...
		Bubble(id){
			const obj = new this.$.$bog_talks_message_bubble();
			(obj.message) = () => ((this.message(id)));
			return obj;
		}
		Rights(){
	...
	($mol_mem(($.$bog_talks_chat_page.prototype), "Rights_icon"));
	($mol_mem(($.$bog_talks_chat_page.prototype), "Rights_link"));
	($mol_mem(($.$bog_talks_chat_page.prototype), "dump_blob"));
	($mol_mem(($.$bog_talks_chat_page.prototype), "Dump"));
	($mol_mem(($.$bog_talks_chat_page.prototype), "Joined_icon"));
	($mol_mem(($.$bog_talks_chat_page.prototype), "joined"));
	($mol_mem(($.$bog_talks_chat_page.prototype), "Joined"));
	($mol_mem(($.$bog_talks_chat_page.prototype), "Search_toggle_icon"));
	($mol_mem(($.$bog_talks_chat_page.prototype), "search_enabled"));
	($mol_mem(($.$bog_talks_chat_page.prototype), "Search_toggle"));
	($mol_mem(($.$bog_talks_chat_page.prototype), "chat"));
	($mol_mem(($.$bog_talks_chat_page.prototype), "messages"));
	($mol_mem_key(($.$bog_talks_chat_page.prototype), "message"));
	($mol_mem_key(($.$bog_talks_chat_page.prototype), "Bubble"));
	($mol_mem(($.$bog_talks_chat_page.prototype), "Rights"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_talks_chat_page extends $.$bog_talks_chat_page {
            domain() {
                return this.$.$bog_talks_domain;
            }
            chat() {
                const id = this.chat_id();
            ...
            update_last_seen_message() {
                ...
                const last_seen = user.last_seen_message(this.chat());
                if (last_seen) {
                    const idx = all.findIndex((m) => m.id === last_seen.id);
                    if (idx >= bottom)
                        return;
                }
        ...
        __decorate([
            $mol_mem
        ], $bog_talks_chat_page.prototype, "messages", null);
        __decorate([
            $mol_mem
        ], $bog_talks_chat_page.prototype, "bubbles", null);
        __decorate([
            $mol_mem
        ], $bog_talks_chat_page.prototype, "joined", null);
        __decorate([
            $mol_mem
        ], $bog_talks_chat_page.prototype, "draft_text", null);
        __decorate([
            $mol_mem
        ], $bog_talks_chat_page.prototype, "update_last_seen_message", null);
        __decorate([
            $mol_mem
        ], $bog_talks_chat_page.prototype, "is_owner", null);
        __decorate([
            $mol_mem
        ], $bog_talks_chat_page.prototype, "rights_panel", null);
        __decorate([
            $mol_mem,
            $mol_action
        ], $bog_talks_chat_page.prototype, "autoscroll", null);
        __decorate([
            $mol_mem
        ], $bog_talks_chat_page.prototype, "auto_join", null);
        $$.$bog_talks_chat_page = $bog_talks_chat_page;
        $mol_view_component($bog_talks_chat_page);
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));

;
	($.$bog_talks) = class $bog_talks extends ($.$hyoo_talks) {
		Online(){
			return null;
		}
		User(){
		...
		Settings(){
			const obj = new this.$.$bog_talks_person_settings();
			(obj.person) = () => ((this.User()));
			return obj;
		}
		chat(id){
		...
		Chat_page(id){
			const obj = new this.$.$bog_talks_chat_page();
			(obj.chat) = () => ((this.chat(id)));
			return obj;
		}
	};
	($mol_mem(($.$bog_talks.prototype), "User"));
	($mol_mem(($.$bog_talks.prototype), "Settings"));
	($mol_mem_key(($.$bog_talks.prototype), "chat"));
	($mol_mem_key(($.$bog_talks.prototype), "Chat_page"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $bog_talks.prototype, "links", null);
        __decorate([
            $mol_mem_key
        ], $bog_talks.prototype, "chat_title", null);
        __decorate([
            $mol_mem_key
        ], $bog_talks.prototype, "chat_unread_count", null);
        __decorate([
            $mol_mem_key
        ], $bog_talks.prototype, "message_notify", null);
        $$.$bog_talks = $bog_talks;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
